  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card overflow-hidden">
        ...
        {secrets.length === 0 && (
          <div className="text-center py-12 text-text-muted">没有找到 Secret</div>
        )}
      </div>
